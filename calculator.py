...
#widgets start from here
        ...
        self.btnpro = Button(win, text="Product")
        self.btnpro.place(x=200, y=200)
        self.btnpro.bind('<Button-1>', self.pro)
        self.btnquo = Button(win, text="Quotient", command = self.quo)
        self.btnquo.place(x=270, y=200)
        self.btnquo.bind('<Button-1>', self.quo)
